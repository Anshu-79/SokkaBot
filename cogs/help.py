    ...
    try:
        ...
        try:
            ...
            await ctx.author.send(
                ...
                f"Could you inform the server mods about this issue?",
                embed=embed,
            )
...
class HelpCog(commands.Cog):
    ...
    async def help(self, ctx, *input):
        ...
        if not input:
            ...
            emb.add_field(
                name="About",
                value=f"This bot is developed & maintained by Anshu79#2928 \n\nPlease DM me to submit ideas & bugs.\n",
            )
            ...
            for cog in self.bot.cogs:
                if cog.replace("Cog", "").lower() == input[0].lower():
                    emb = disnake.Embed(
                        title=f"{cog.replace('Cog', '')} - Commands",
